...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.seo-head','data' => ['title' => $article->seo_title,'description' => $article->seo_description,'ogImage' => route('og.image', ['type' => 'article', 'id' => $article->id]),'jsonLd' => [
