        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 space-y-6">
                <div>
                    ...
                    <input type="text" name="title" value="<?php echo e(old('title')); ?>" placeholder="Contoh: {Cara|Tips} Sukses Bisnis {Kopi|Cafe}"
                ...
                <div>
                    ...
                    <textarea name="content" id="article-content" rows="15" 
                              class="w-full bg-gray-50 border-gray-100 rounded-xl px-5 py-4 focus:ring-amber-500 focus:border-amber-500 transition-all"><?php echo e(old('content')); ?></textarea>
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="focus_keyword" value="<?php echo e(old('focus_keyword')); ?>" placeholder="e.g. bisnis kopi" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3 focus:ring-amber-500 focus:border-amber-500">
                    </div>
                    <div>
                        <label class="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Canonical URL (Opsional)</label>
                        <input type="text" name="canonical_url" value="<?php echo e(old('canonical_url')); ?>" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3 focus:ring-amber-500 focus:border-amber-500">
                    </div>
                </div>
            </div>
        </div>
