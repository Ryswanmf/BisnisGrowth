...
<?php $__env->startSection('title', 'Tulis Artikel Baru'); ?>
<?php $__env->startSection('header', 'Tulis Artikel'); ?>
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="excerpt" rows="3" class="w-full bg-gray-50 border-gray-100 rounded-xl px-5 py-3 focus:ring-amber-500 focus:border-amber-500"><?php echo e(old('excerpt')); ?></textarea>
                </div>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="meta_title" value="<?php echo e(old('meta_title')); ?>" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3 focus:ring-amber-500 focus:border-amber-500">
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Meta Description</label>
                        <textarea name="meta_description" rows="3" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3 focus:ring-amber-500 focus:border-amber-500"><?php echo e(old('meta_description')); ?></textarea>
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Domain Canonical</label>
                        <select id="domain_selector" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3 focus:ring-amber-500 focus:border-amber-500 text-sm font-bold mb-2">
                            ...
                            <?php $__currentLoopData = $domains; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $domain): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($domain->url); ?>"><?php echo e($domain->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <input type="text" name="canonical_url" id="canonical_url" value="<?php echo e(old('canonical_url')); ?>" placeholder="URL Lengkap (Otomatis terisi jika domain dipilih)" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3 focus:ring-amber-500 focus:border-amber-500 text-sm">
                    </div>
                    <div class="md:col-span-2" x-data="{ 
                        ...
                        <div class="relative">
                            <button type="button" @click="open = !open" 
                                    class="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-3 flex items-center justify-between hover:bg-white transition-all focus:ring-2 focus:ring-amber-500">
                            ...
                            <div x-show="open" @click.away="open = false" 
                                 ...
                                 class="absolute z-50 mt-2 w-full bg-white rounded-2xl shadow-xl border border-gray-100 p-4 space-y-4">
                                
                                <!-- Search Input -->
                                <input type="text" x-model="search" placeholder="Cari pool..." 
                                       class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-2 text-xs focus:ring-amber-500 focus:border-amber-500">

                                <!-- Items List -->
                                <div class="max-h-60 overflow-y-auto custom-scrollbar space-y-1">
                                    <template x-for="item in filteredItems" :key="item.id">
                                        <label class="flex items-center p-2 rounded-lg cursor-pointer hover:bg-amber-50 transition-colors group">
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="image_alt" value="<?php echo e(old('image_alt')); ?>" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-2 text-sm focus:ring-amber-500 focus:border-amber-500">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <?php $__currentLoopData = ['image_2', 'image_3', 'image_4']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imgField): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Gambar <?php echo e(substr($imgField, -1)); ?></label>
                            <input type="file" name="<?php echo e($imgField); ?>" class="w-full text-xs text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-black file:bg-slate-50 file:text-slate-600 hover:file:bg-slate-100">
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                ...
                <select name="category_name" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3 text-sm focus:ring-amber-500 focus:border-amber-500 font-bold" required>
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($cat->name); ?>" <?php echo e(old('category_name') == $cat->name ? 'selected' : ''); ?>><?php echo e($cat->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\BisnisGrowth\resources\views/admin/articles/create.blade.php ENDPATH**/ ?>