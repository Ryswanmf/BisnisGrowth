...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="pt-4 flex gap-4">
                ...
                <a href="<?php echo e(route('admin.internal-links.index')); ?>" class="px-8 py-4 bg-gray-100 text-gray-400 rounded-lg text-xs font-black uppercase tracking-widest hover:bg-gray-200 transition-all">
                    Batal
                </a>
            </div>
        </form>
