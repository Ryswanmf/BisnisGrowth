...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 sticky top-0 z-50 shadow-sm py-2">
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-gray-100 absolute w-full left-0 shadow-lg">
        <div class="px-4 pt-4 pb-6 space-y-3">
            ...
            <a href="<?php echo e(route('article.index')); ?>" class="block px-4 py-3 rounded-xl text-sm font-bold text-gray-700 hover:bg-burgundy-50 hover:text-burgundy-600 transition-colors">Artikel</a>
            <a href="<?php echo e(route('contact')); ?>" class="block px-4 py-3 rounded-xl text-sm font-bold text-gray-700 hover:bg-burgundy-50 hover:text-burgundy-600 transition-colors">Kontak</a>
