        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-10 rounded-[3rem] shadow-sm border border-gray-100 text-center group hover:shadow-2xl hover:shadow-slate-200 transition-all duration-500">
                    ...
                    <p class="text-gray-500 font-medium"><?php echo e($footerSetting->email ?? 'hello@bisnisgrowth.id'); ?></p>
                </div>
                ...
                <div class="bg-white p-10 rounded-[3rem] shadow-sm border border-gray-100 text-center group hover:shadow-2xl hover:shadow-slate-200 transition-all duration-500">
                    ...
                    <p class="text-gray-500 font-medium"><?php echo e($footerSetting->phone ?? '+62 812-3456-7890'); ?></p>
                </div>
                ...
                <div class="bg-white p-10 rounded-[3rem] shadow-sm border border-gray-100 text-center group hover:shadow-2xl hover:shadow-slate-200 transition-all duration-500">
                    ...
                    <p class="text-gray-500 font-medium leading-relaxed"><?php echo e($footerSetting->address ?? 'Jakarta, Indonesia.'); ?></p>
                </div>
            </div>
