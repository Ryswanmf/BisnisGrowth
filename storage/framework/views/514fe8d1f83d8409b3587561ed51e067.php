    ...
    <div>
        ...
        <div class="space-y-1">
            ...
            <a href="<?php echo e(route('admin.domains.index')); ?>"
               class="<?php echo e(request()->routeIs('admin.domains*')
                        ? 'bg-amber-400/10 text-amber-400 border-l-4 border-amber-400'
                        : 'text-white/60 hover:bg-white/5 hover:text-white border-l-4 border-transparent'); ?>

                        group flex items-center px-4 py-3 text-sm font-semibold transition-all duration-200">
                <svg class="mr-3 h-5 w-5 <?php echo e(request()->routeIs('admin.domains*') ? 'text-amber-400' : 'text-white/30 group-hover:text-amber-400'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"/>
                </svg>
                Domain Canonical
            </a>

            <a href="<?php echo e(route('admin.short-keywords.index')); ?>"
               class="<?php echo e(request()->routeIs('admin.short-keywords*')
                        ? 'bg-amber-400/10 text-amber-400 border-l-4 border-amber-400'
                        : 'text-white/60 hover:bg-white/5 hover:text-white border-l-4 border-transparent'); ?>

                        group flex items-center px-4 py-3 text-sm font-semibold transition-all duration-200">
                <svg class="mr-3 h-5 w-5 <?php echo e(request()->routeIs('admin.short-keywords*') ? 'text-amber-400' : 'text-white/30 group-hover:text-amber-400'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14"/>
                </svg>
                Short Keyword
            </a>

            <a href="<?php echo e(route('admin.internal-links.index')); ?>"
               class="<?php echo e(request()->routeIs('admin.internal-links*')
                        ? 'bg-amber-400/10 text-amber-400 border-l-4 border-amber-400'
                        : 'text-white/60 hover:bg-white/5 hover:text-white border-l-4 border-transparent'); ?>

                        group flex items-center px-4 py-3 text-sm font-semibold transition-all duration-200">
                <svg class="mr-3 h-5 w-5 <?php echo e(request()->routeIs('admin.internal-links*') ? 'text-amber-400' : 'text-white/30 group-hover:text-amber-400'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
