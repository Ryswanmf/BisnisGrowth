    ...
    <div class="bg-slate-900 p-8 md:p-12 rounded-xl shadow-2xl relative overflow-hidden text-white group">
        ...
        <div class="relative z-10 max-w-2xl">
            ...
            <div class="flex flex-wrap gap-4">
                <a href="<?php echo e(route('admin.articles.create')); ?>" class="px-8 py-4 bg-amber-500 text-slate-900 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-amber-400 transition-all shadow-lg shadow-amber-500/20">Tulis Artikel Baru</a>
                <a href="<?php echo e(route('admin.traffic.index')); ?>" class="px-8 py-4 bg-white/5 border border-white/10 text-white rounded-xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-white/10 transition-all">Lihat Traffic</a>
            </div>
        </div>
    </div>
