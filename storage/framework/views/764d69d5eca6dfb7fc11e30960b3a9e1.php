...
<form action="<?php echo e(route('admin.articles.update', $article->id)); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 space-y-6">
                <div>
                    ...
                    <input type="text" name="title" value="<?php echo e(old('title', $article->title)); ?>" class="w-full bg-gray-50 border-gray-100 rounded-2xl px-5 py-4 focus:ring-amber-500 font-bold text-lg">
                </div>
                ...
                <div>
                    ...
                    <textarea name="content" id="article-content" rows="15" 
                              class="w-full bg-gray-50 border-gray-100 rounded-2xl px-5 py-4 focus:ring-amber-500 transition-all"><?php echo e(old('content', $article->content)); ?></textarea>
                ...
                <div>
                    ...
                    <textarea name="excerpt" rows="3" class="w-full bg-gray-50 border-gray-100 rounded-2xl px-5 py-3 focus:ring-amber-500"><?php echo e(old('excerpt', $article->excerpt)); ?></textarea>
                </div>
            </div>
            ...
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="canonical_url" value="<?php echo e(old('canonical_url', $article->canonical_url)); ?>" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-6">
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 space-y-6">
                <button type="submit" class="w-full bg-amber-500 text-slate-900 py-4 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-amber-400 shadow-lg">Perbarui Artikel</button>
            ...
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 space-y-6">
                ...
                <?php if($article->image): ?>
                    <div class="relative group">
                        <img src="<?php echo e(asset('storage/' . $article->image)); ?>" class="w-full h-32 object-cover rounded-xl border border-gray-100 shadow-sm">
