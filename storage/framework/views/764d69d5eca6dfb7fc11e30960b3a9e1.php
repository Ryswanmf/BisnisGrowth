        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 space-y-6">
                <div>
                    ...
                    <input type="text" name="title" value="<?php echo e(old('title', $article->title)); ?>" class="w-full bg-gray-50 border-gray-100 rounded-xl px-5 py-4 focus:ring-amber-500 font-bold text-lg">
                </div>
                ...
                <div>
                    ...
                    <textarea name="excerpt" rows="3" class="w-full bg-gray-50 border-gray-100 rounded-xl px-5 py-3 focus:ring-amber-500"><?php echo e(old('excerpt', $article->excerpt)); ?></textarea>
                </div>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="meta_title" value="<?php echo e(old('meta_title', $article->meta_title)); ?>" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3">
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Meta Description</label>
                        <textarea name="meta_description" rows="3" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3"><?php echo e(old('meta_description', $article->meta_description)); ?></textarea>
                    </div>
                    <div>
                        <label class="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Focus Keyword</label>
                        <input type="text" name="focus_keyword" value="<?php echo e(old('focus_keyword', $article->focus_keyword)); ?>" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3">
                    </div>
                    <div>
                        ...
                        <input type="text" name="canonical_url" id="canonical_url" value="<?php echo e(old('canonical_url', $article->canonical_url)); ?>" placeholder="URL Lengkap" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3 focus:ring-amber-500 text-sm">
                    </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 space-y-6">
                ...
                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="is_published" value="1" class="sr-only peer" <?php echo e($article->is_published ? 'checked' : ''); ?>>
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 space-y-6">
                ...
                <?php if($article->image): ?>
                    <div class="relative group">
                        <img src="<?php echo e(asset($article->image)); ?>" class="w-full h-32 object-cover rounded-xl border border-gray-100 shadow-sm">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="image_alt" value="<?php echo e(old('image_alt', $article->image_alt)); ?>" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-2 text-sm">
                    </div>
                </div>
            </div>
                    ...
                    <?php $__currentLoopData = ['image_2', 'image_3', 'image_4']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imgField): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="space-y-3">
                            ...
                            <?php if($article->$imgField): ?>
                                <img src="<?php echo e(asset('storage/' . $article->$imgField)); ?>" class="h-20 w-full object-cover rounded-lg border border-gray-100">
                            <?php endif; ?>
