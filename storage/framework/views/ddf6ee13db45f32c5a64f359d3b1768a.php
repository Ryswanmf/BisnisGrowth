...
<?php $__env->startSection('header', 'Pengaturan Umum'); ?>
...
...
        ...
        <div x-show="tab === 'maintenance'" x-transition class="bg-white p-8 md:p-12 rounded-lg border border-gray-100 shadow-sm space-y-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="p-8 bg-slate-50 rounded-[2rem] border border-gray-100 space-y-4">
                    ...
                    <a href="<?php echo e(route('admin.settings.backup')); ?>" class="inline-block px-6 py-3 bg-amber-500 text-slate-900 rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-amber-400 transition-all shadow-lg shadow-amber-500/10">
                        Download Backup
                    </a>
                </div>
            </div>
        ...
        <div x-show="tab === 'identity'" x-transition class="bg-white p-8 md:p-12 rounded-lg border border-gray-100 shadow-sm space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="space-y-2">
                    ...
                    <input type="text" name="site_name" value="<?php echo e($settings['site_name'] ?? 'BisnisGrowth'); ?>" class="w-full bg-gray-50 border-none rounded-lg px-5 py-4 text-sm font-bold focus:ring-2 focus:ring-amber-500">
                </div>
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Tagline</label>
                    <input type="text" name="site_tagline" value="<?php echo e($settings['site_tagline'] ?? 'Satu Link untuk Semua Bisnismu'); ?>" class="w-full bg-gray-50 border-none rounded-lg px-5 py-4 text-sm font-bold focus:ring-2 focus:ring-amber-500">
                </div>
            </div>

            <div class="space-y-2">
                <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Deskripsi Bisnis</label>
                <textarea name="site_description" rows="4" class="w-full bg-gray-50 border-none rounded-lg px-5 py-4 text-sm font-medium focus:ring-2 focus:ring-amber-500"><?php echo e($settings['site_description'] ?? ''); ?></textarea>
            </div>
        </div>
        ...
        <div x-show="tab === 'seo'" x-transition class="bg-white p-8 md:p-12 rounded-lg border border-gray-100 shadow-sm space-y-8">
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="ga_id" value="<?php echo e($settings['ga_id'] ?? ''); ?>" placeholder="G-XXXXXXXXXX" class="w-full bg-gray-50 border-none rounded-lg px-5 py-4 text-sm font-bold focus:ring-2 focus:ring-amber-500">
            </div>

            <div class="space-y-2">
                <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Meta Keywords</label>
                <input type="text" name="meta_keywords" value="<?php echo e($settings['meta_keywords'] ?? ''); ?>" placeholder="umkm, bisnis, edukasi, direktori" class="w-full bg-gray-50 border-none rounded-lg px-5 py-4 text-sm font-bold focus:ring-2 focus:ring-amber-500">
            </div>
        </div>
        ...
        <div x-show="tab === 'api'" x-transition class="bg-white p-8 md:p-12 rounded-lg border border-gray-100 shadow-sm space-y-8">
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="official_whatsapp" value="<?php echo e($settings['official_whatsapp'] ?? '089515915699'); ?>" class="w-full bg-gray-50 border-none rounded-lg px-5 py-4 text-sm font-bold focus:ring-2 focus:ring-amber-500">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\BisnisGrowth\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>