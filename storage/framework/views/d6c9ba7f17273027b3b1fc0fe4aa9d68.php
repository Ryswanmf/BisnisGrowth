                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" 
                                ...
                                <div class="px-4 py-3 bg-gray-50 border-b border-gray-100 flex justify-between items-center">
                                    ...
                                    <span class="bg-amber-500 text-white text-[9px] font-black px-2 py-0.5 rounded-full"><?php echo e($unreadCount); ?></span>
                                </div>
                                <div class="max-h-96 overflow-y-auto custom-scrollbar">
                                    <?php $__empty_1 = true; $__currentLoopData = $unreadMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <a href="<?php echo e(route('admin.messages.index')); ?>" class="block px-4 py-4 hover:bg-amber-50 transition-colors border-b border-gray-50 last:border-0">
                                            <div class="flex gap-3">
                                                ...
                                                <div class="min-w-0">
                                                    <p class="text-xs font-black text-slate-900 truncate mb-0.5"><?php echo e($msg->name); ?></p>
                                                    <p class="text-[10px] text-gray-500 line-clamp-1 mb-1"><?php echo e($msg->message); ?></p>
                                                    <p class="text-[8px] font-bold text-amber-600 uppercase tracking-tighter"><?php echo e($msg->created_at->diffForHumans()); ?></p>
                                                </div>
                                            </div>
                                        </a>
                                ...
                                <a href="<?php echo e(route('admin.messages.index')); ?>" class="block py-3 text-center text-[10px] font-black uppercase tracking-widest bg-slate-900 text-white hover:bg-amber-500 hover:text-slate-900 transition-all">
                                    Lihat Semua Pesan
                                </a>
                            </div>
                        </div>
