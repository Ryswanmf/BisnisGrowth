        ...
        <aside class="hidden md:flex md:flex-col md:w-64 bg-slate-900 text-white shrink-0 shadow-xl border-r border-white/5 h-full">
            ...
            <div class="p-4 bg-slate-950/30 border-t border-white/5 shrink-0">
                <div class="flex items-center gap-3">
                    <div class="h-8 w-8 bg-amber-500 rounded-md flex items-center justify-center text-slate-900 font-bold text-xs uppercase">{{ substr(Auth::user()->name, 0, 1) }}</div>
                ...
                <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                    ...
                    <div class="p-4 bg-slate-950/30 border-t border-white/5 mt-auto">
                        <div class="flex items-center justify-between gap-3">
                            <div class="flex items-center gap-3">
                                <div class="h-10 w-10 bg-amber-500 rounded-lg flex items-center justify-center text-slate-900 font-bold text-sm uppercase shadow-lg shadow-amber-500/20">{{ substr(Auth::user()->name, 0, 1) }}</div>
