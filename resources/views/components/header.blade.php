...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 sticky top-0 z-50 shadow-sm py-2">
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-gray-100 absolute w-full left-0 shadow-lg">
        <div class="px-4 pt-4 pb-6 space-y-3">
            <!-- Mobile Search Bar -->
            <form action="/direktori" method="GET" class="relative mb-6">
                <input type="text" name="q" placeholder="Cari bisnis..." 
            ...
            <div class="pt-4 border-t border-gray-100">
                ...
                @else
                    <div class="grid grid-cols-2 gap-3">
                        <a href="/login" class="block text-center px-4 py-3 rounded-xl border border-gray-200 text-gray-600 font-bold text-xs uppercase tracking-widest hover:bg-gray-50 transition-colors">Masuk</a>
                        <a href="/register" class="block text-center btn-primary !py-3 !text-xs uppercase tracking-widest shadow-none">Daftar</a>
                    </div>
                @endauth
            </div>
        </div>
