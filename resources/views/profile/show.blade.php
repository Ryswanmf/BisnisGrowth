        ...
        <div class="px-6 pb-12 -mt-16 flex-grow relative z-10 text-center">
            ...
            <div class="inline-block relative">
                <img src="{{ $business->logo ? asset($business->logo) : 'https://ui-avatars.com/api/?name=' . urlencode($business->name) . '&background=7B1F2E&color=FFF8E7' }}" 
                     alt="{{ $business->name }}" 
                     class="w-32 h-32 rounded object-cover border-4 border-white shadow-lg mx-auto bg-white">
                @if($business->is_verified)
                    <div class="absolute bottom-1 right-1 bg-gold-400 text-burgundy-800 rounded p-1.5 shadow-md border-2 border-white" title="Terverifikasi">
