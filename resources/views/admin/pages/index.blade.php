...
<div class="space-y-6">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <a href="{{ route('admin.pages.create') }}" class="bg-amber-500 text-slate-900 px-6 py-3 rounded-2xl text-sm font-black flex items-center gap-2 hover:bg-amber-400 transition-all shadow-lg shadow-amber-500/20">
                ...
                <tr class="hover:bg-gray-50/50 transition-colors group">
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="flex justify-end gap-2">
                            <a href="{{ route('admin.pages.edit', $page) }}" class="p-2 bg-white border border-gray-100 rounded-lg text-gray-400 hover:text-amber-500 transition-all">
