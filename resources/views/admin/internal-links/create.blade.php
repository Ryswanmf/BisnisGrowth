...
@section('title', 'Tambah Tautan Internal')
@section('header', 'Tambah Tautan Internal')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
        <form action="{{ route('admin.internal-links.store') }}" method="POST" class="space-y-6">
            @csrf
            <div>
                <label class="block text-xs font-black text-slate-900 uppercase tracking-widest mb-2">Kata Kunci</label>
                <input type="text" name="keyword" value="{{ old('keyword') }}" placeholder="Contoh: Bisnis Kopi" 
            ...
            <div>
                ...
                <input type="url" name="url" value="{{ old('url') }}" placeholder="https://bisnisgrowth.id/..." 
            ...
            <div>
                ...
                <input type="number" name="limit" value="{{ old('limit', 1) }}" min="1" max="10"
