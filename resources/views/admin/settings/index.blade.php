...
...
        <!-- Tab: Maintenance -->
        <div x-show="tab === 'maintenance'" x-transition class="bg-white p-8 md:p-12 rounded-[3rem] border border-gray-100 shadow-sm space-y-10">
            <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="p-8 bg-slate-50 rounded-[2rem] border border-gray-100 space-y-4">
                    <div class="h-12 w-12 bg-blue-500 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-blue-500/20">
                ...
                <div class="p-8 bg-slate-50 rounded-[2rem] border border-gray-100 space-y-4">
                    <div class="h-12 w-12 bg-amber-500 rounded-2xl flex items-center justify-center text-slate-900 shadow-lg shadow-amber-500/20">
