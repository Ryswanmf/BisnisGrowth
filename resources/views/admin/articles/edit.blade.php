        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 space-y-6">
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title', $article->title) }}" class="w-full bg-gray-50 border-gray-100 rounded-2xl px-5 py-4 focus:ring-amber-500 font-bold text-lg">
                </div>
                ...
                <div>
                    ...
                    <textarea name="content" id="article-content" rows="15" 
                              class="w-full bg-gray-50 border-gray-100 rounded-2xl px-5 py-4 focus:ring-amber-500 transition-all">{{ old('content', $article->content) }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="excerpt" rows="3" class="w-full bg-gray-50 border-gray-100 rounded-2xl px-5 py-3 focus:ring-amber-500">{{ old('excerpt', $article->excerpt) }}</textarea>
                </div>
            </div>
            ...
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 space-y-6">
                ...
                @if($article->image)
                    <div class="relative group">
                        <img src="{{ asset('storage/' . $article->image) }}" class="w-full h-32 object-cover rounded-xl border border-gray-100 shadow-sm">
