                    ...
                    <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-100 group hover:shadow-xl transition-all duration-500">
                        <div class="flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-bold text-slate-900">{{ $footerSetting->email ?? 'hello@bisnisgrowth.id' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-100 group hover:shadow-xl transition-all duration-500">
                        <div class="flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-bold text-slate-900">{{ $footerSetting->phone ?? '+62 812-3456-7890' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-100 group hover:shadow-xl transition-all duration-500">
                        <div class="flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-bold text-slate-900 leading-relaxed">{{ $footerSetting->address ?? 'Jakarta, Indonesia.' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
